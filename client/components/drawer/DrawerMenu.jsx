        ...
        >
          ...
          <View style={styles.footer}>
            ...
            <View style={styles.socialRow}>
              {['logo-apple', 'logo-google-playstore', 'logo-youtube', 'logo-facebook', 'logo-instagram', 'logo-linkedin'].map((icon) => (
                <Ionicons key={icon} name={icon} size={22} color={COLORS.textSecondary} />
              ))}
            </View>
